...
class Office365Instance(models.Model):
	...
	task_states = fields.Many2many('project.task.type', string="Select Task States")

	@api.onchange('task_states')
	def lenght_of_states(self):
		if len(self.task_states) > 3:
			raise UserError(_("Message: Select Only 3 States of Task!"))
