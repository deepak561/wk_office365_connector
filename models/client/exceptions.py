...
class Office365RestApiError(Exception):
	...
	from odoo.addons.wk_office365_connector.models import execptions
	from odoo.addons.wk_office365_connector.models.execptions import Office365RestApiError
	"""
